...
const episodes = [
    ...
    { id: 13, title: '第13話', subtitle: 'エンドレスエイト(2)', synopsis: 'どうやら、世界がループしているらしい。9月1日以降の世界がごっそりとなくなっていて、ひたすら8月17日から8月31日までをグルグルと周遊しているということが朝比奈みくるの言動からはっきりする。そうした状況に納得のいく古泉、未来に帰れず泣きじゃくるみくる、無言で俯く長門、そこで納得のいかないキョン。なぜこうなってしまったのか!?', image: './material/onair/MainStory/13.jpg' },
    ...
    { id: 26, title: '第26話', subtitle: 'ライブアライブ', synopsis: 'ハルヒが監督した超スペクタクルマジカルラブロマンス映画は、なんとか上映に漕ぎ着けることができた。｢よくやってぞ、俺｣と褒めてくれるのは自分しかいない現実を確認し、疲れ気味に校内をぶらついて、たまたま体育館を覗いてみたのだが…。眠気が一気に吹っ飛んだ。壇上にあのハルヒが現れたのである!｢今度は一体何をしようってんだ!?｣という不安をよそに、長門の超絶ギターソロが始まった。ハルヒの熱唱に体育館は異常な盛り上がりを見せる…。', image: './material/onair/MainStory/26.jpg' },
